class BooksController < ApplicationController
    ...
    def borrow
      if !logged_in?
        ...
        ExampleMailer.borrow_book(@current_user,@booksBorrow).deliver_now
        ExampleMailer.borrow_book(@current_user,@booksBorrow).deliver_later(wait_until: 2.minutes.from_now)
        if @booksBorrow.save
